...
namespace DataAccessLayer.Repositories.Interfaces
{
    public interface IFeedbackRepo
    {
        ...
        Task<bool> RestoreFeedbackAsync(string feedbackId, string userId);
        Task<Feedback?> GetFeedbackByIdAsync(string feedbackId);
        Task<Feedback?> GetFeedbackByIdIncludingDeletedAsync(string feedbackId);
        Task<Feedback?> GetUserFeedbackForCourseAsync(string userId, string courseId);
        Task<Feedback?> GetUserFeedbackForCourseIncludingDeletedAsync(string userId, string courseId);
