...
namespace BusinessLogicLayer.Services.Implementations
{
    ...
    /// </summary>
    public class AchievementUnlockServiceImpl : IAchievementUnlockService
    {
        ...
        private readonly ILogger<AchievementUnlockServiceImpl> _logger;

        public AchievementUnlockServiceImpl(
            BrainStormEraContext context,
            IAchievementRepo achievementRepo,
            IAchievementNotificationService notificationService,
            IMemoryCache cache,
            ILogger<AchievementUnlockServiceImpl> logger)
        {
            _context = context;
