...
namespace BusinessLogicLayer.Services.Implementations
{
    ...
    /// </summary>
    public class AchievementNotificationServiceImpl : IAchievementNotificationService
    {
        private readonly BrainStormEraContext _context;
        private readonly INotificationService _notificationService;
        private readonly ILogger<AchievementNotificationServiceImpl> _logger;

        public AchievementNotificationServiceImpl(
            BrainStormEraContext context,
            INotificationService notificationService,
            ILogger<AchievementNotificationServiceImpl> logger)
        {
            _context = context;
