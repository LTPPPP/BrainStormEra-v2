...
function testChatbotMemory() {
    ...
    if (window.chatbotManager) {
        ...
        console.log("📊 Current conversation length:", window.chatbotManager.messages.length);
        
    } else {
        console.log("❌ Chatbot Manager not found - make sure user is authenticated");
    }
    
    console.log("🎯 Test Summary:");
    console.log("- The chatbot will now remember conversations across page interactions");
    console.log("- History is stored in sessionStorage (cleared when tab is closed)");
    console.log("- Use 'New Chat' button to clear conversation history");
    console.log("- Conversation persists during page navigation within the same session");
}
