...
namespace BrainStormEra_MVC.Services
{
    public class NotificationService : INotificationService
    {
        ...
        public async Task<bool> SendToUserAsync(string userId, string title, string content, string? type = null, string? courseId = null)
        {
            try
            {
                // Create notification in database
                var notification = await CreateNotificationAsync(userId, title, content, type, courseId);
        ...
        public async Task<bool> SendToCourseAsync(string courseId, string title, string content, string? type = null, string? excludeUserId = null)
        {
            try
            {                // Get all enrolled users in the course
                ...
                {
                    await CreateNotificationAsync(userId, title, content, type, courseId);
                });
        ...
        public async Task<bool> SendToRoleAsync(string role, string title, string content, string? type = null)
        {
            try
            {                // Get all users with the specified role
                ...
                {
                    await CreateNotificationAsync(userId, title, content, type);
                });
        ...
        public async Task<bool> SendToAllAsync(string title, string content, string? type = null)
        {
            try
