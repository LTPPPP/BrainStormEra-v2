...
- **🌐 MVC Application**: [https://localhost:5001](https://localhost:5001) (HTTPS) | [http://localhost:5000](http://localhost:5000) (HTTP)
- **🌐 Razor Application**: [https://localhost:5003](https://localhost:5003) (HTTPS) | [http://localhost:5002](http://localhost:5002) (HTTP)
